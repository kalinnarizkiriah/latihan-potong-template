<!-- Ini adalah langkah ketiga setelah dr file action_insert_portfolio.php -->
                        ...
                        <tbody>
                            ...
                            while ($tampil = mysqli_fetch_object($select_portfolio)):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="foto/<?php echo $tampil->img; ?>" alt="" width="100">
                                    </td> 
                                    ...
                                    <td>
                                        <a href="delete_portfolio.php?id_portfolio=<?php echo $tampil->id_portfolio;?>" class="btn btn-danger" 
