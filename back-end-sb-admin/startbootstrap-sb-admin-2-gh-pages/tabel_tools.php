    ...
    while ($tampil=mysqli_fetch_object($select_tools)):
        ...
        <tr>
            ...
            <td>
                ...
                <td>
                <a href="delete_tools.php?id_tools=<?php echo $tampil->id_tools; ?>"
                class="btn btn-danger" onclick="return confirm('Confirm to delete?')">DELETE</a>
                <a href="update_form_tools.php?id_tools=<?php echo $tampil->id_tools; ?>" class="btn btn-success">UPDATE</a>
                </td>
                </tr>
                <?php endwhile ?>
                </tbody>
