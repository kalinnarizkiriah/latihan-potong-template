<!-- we are dr file tabel_portfolio -->
<!-- next: copy the data form_portfolio -->
<?php
include "connection.php";
// menyimpan sementara id_portfolio dari tombol UPDATE tabel_portfolio.php sebelum dieksekusi ke bawah berikut ini
// $_GET['id_portfolio']; yg menerima id_portfolio dr tombol UPDATE tabel_portfolio.php
$id_portfolio = $_GET['id_portfolio'];

// menampilkan data portfolio yang didapat atau dikirim dari tombol UPDATE tabel_portfolio.php di atas
...
// di bawah ini adalah isi asli dari form.portfolio
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="action_update_portfolio.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="judul" class="form-label">Portfolio</label>
                            <input type="text" class="form-control" id="judul" name="judul_portfolio" value="<?php echo $portfolio->judul_portfolio ?>">
                        </div>

                        <div class="mb-3">
                            <label for="img" class="form-label">Image</label>
                            <input type="file" class="form-control" id="img" name="img" value="<?php echo $portfolio->img ?>">
                        </div>
