...
<tbody>
    ...
    <tr>
        ...
        <td>
            <a href="delete_reference.php?id_reference=<?php echo $tampil->id_reference;?>" class="btn btn-danger"
            onclick="return confirm('Confirm to delete?')">DELETE</a>
            <a href="update_form_reference.php?id_reference=<?php echo $tampil->id_reference;?>" class="btn btn-success">UPDATE</a>
            </td>
                                </tr>
                            <?php endwhile ?>
    </tbody>
